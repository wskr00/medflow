...
describe("PatientBookingComponent", () => {
  it("identifica visual e textualmente o horário selecionado", async () => {
    ...
    const component = fixture.componentInstance as unknown as { model: { set(value: { specialtyId: string; unitId: string; doctorId: string }): void }; stage: { set(value: number): void } };
    component.model.set({ specialtyId: "specialty", unitId: "unit", doctorId: "" }); component.stage.set(2); fixture.detectChanges();
    http.expectOne((request) => request.url.includes("/disponibilidades")).flush({ timeZone: "America/Belem", items: [{ regraAgendaId: "rule", inicio: "2026-09-18T10:00:00-03:00", fim: "2026-09-18T10:30:00-03:00", medico: { id: "doctor", nome: "Dra. Ana" }, especialidade: { id: "specialty", nome: "Cardiologia" }, unidade: { id: "unit", nome: "Centro" }, consultorio: { id: "room", nome: "101" } }] });
    await fixture.whenStable(); fixture.detectChanges();
    (fixture.nativeElement.querySelector('[aria-pressed="false"]') as HTMLButtonElement).click(); fixture.detectChanges();
    expect(fixture.nativeElement.textContent).toContain("Selecionado");
    expect(fixture.nativeElement.querySelector('[aria-pressed="true"]')).toBeTruthy();
    http.verify();
  });
